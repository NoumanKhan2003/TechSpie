      ...
      <section className="container mx-auto px-4 z-10 flex flex-col md:flex-row gap-12 py-24">
        <div id="tilt-head" className="w-full md:w-1/2 space-y-6 relative">
          <h1 id="tilt" ref={tiltRef}>
            <span className="block text-5xl md:text-7xl font-bold mb-2 bg-gradient-to-b from-gray-700 to-violet-500 bg-clip-text text-transparent pl-2 pt-3">
              Transforming Ideas
            </span>
            <span className="block text-3xl md:text-5xl font-bold bg-gradient-to-b from-gray-700 to-violet-500 bg-clip-text text-transparent pl-2">
        ...
        <div className="w-full md:w-1/2 flex justify-center items-center">
          <div className="relative w-full h-96 rounded-2xl overflow-hidden shadow-2xl hover-3d-deep">
            <div className="absolute inset-0 bg-gradient-to-br from-violet-500/30 to-purple-700/40 backdrop-blur-sm rounded-2xl"></div>
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="text-center p-8">
                <div className="text-white text-7xl font-bold mb-4 hover-tilt">
                  &lt;/&gt;
                </div>
